...
const Hero = () => (
  <Section row nopadding>
    <LeftSection>
      ...
      {"Solid experience working with a number of technologies in web development and data-science, covering from several languages, architectures, frameworks and database solutions to the most popular data analysis and visualization libraries, as well as a number of oriented to AI and machine learning libraries. "}
